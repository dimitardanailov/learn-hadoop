...
#
# Note, this program is wittern in a simple style and does not full advantage of Python
# data structures, but I believe it is more readable.
# 
# Note there is NO error checking of the input, it is assume to be correct
# meaning no extra spaces, missing inputs or counts, etc..
#
# See https://docs.python.org/2/tutorial/index.html for details  and python  tutorials
# -------------------------------------------------------------------------
